      ...
      <View style={styles.featuredContainer}>
        ...
        <View style={styles.featuredDiscription}>
          <TouchableOpacity onPress={() => console.log('first')}>
            ...
            {item.discription && (
              <AppText style={styles.description}>{item.discription}</AppText>
            )}
            {item.date && (
            ...
            {item.rating && (
              <View style={styles.rating}>
                ...
                <AppText style={styles.ratingUsers}>({item.users})</AppText>
              </View>
            )}
          </TouchableOpacity>
        </View>
        ...
        {item.isJoin && (
          <TouchableOpacity
            ...
            <AppText style={styles.joinButtonText}>
              Elizabeth <Feather name="check" size={20} color="green" />
            </AppText>
          </TouchableOpacity>
        )}
      </View>
