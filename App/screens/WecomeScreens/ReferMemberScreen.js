...
const ReferMemberScreen = ({navigation}) => {
  ...
  const renderInputField = (
    ...
    <View style={styles.inputContainer}>
      ...
      <TextInput
        ...
        keyboardType={keyboardType} // Set the keyboardType based on the parameter
      />
    </View>
  );
  ...
  // const InvitationReference = async () => {
  //   setLoading(true);
  //   try {
  //     const response = await axios.post(
  //       `https://privont.com/InvitationReference/Invite?UserType=${selectedOption}`,
  //       userData,
  //     );
  ...
  const saveButtonHandler = async () => {
    ...
    try {
      const response = await axios.post(
        `${BaseUrl}InvitationReference/Invite?TypeUser=${selectedOption}`,
        userData,
      );
...
export default ReferMemberScreen;
